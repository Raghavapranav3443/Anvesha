"""Agentic controller for Anvesha AI.
...
class AgentController:
    ...
    def __init__(self, registry: Optional[Dict[str, ToolSpec]] = None) -> None:
        ...
        # No-op when no enrichers are registered or ANVESHA_PATCHES=0; the
    ...
    def _attach_acquisition_context(result: "AgentResult", params: Dict) -> None:
        ...
        for an area (``anvesha.acquire.providers.bhuvan``: a blank tile from the
    ...
    def _run_investigation(self, imgs: List[RSImage], query: str,
        ...
        # One shared formula (anvesha.impact.impact_confidence). The copy that
...
def write_report(result: AgentResult, images: Sequence[RSImage],
    ...
    payload = {
        "system": f"Anvesha AI v{_VERSION}",
