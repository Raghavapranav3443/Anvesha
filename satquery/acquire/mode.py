...
Escape hatch
------------
``SATQUERY_AIRGAP_GUARD=0`` disables enforcement. It is for diagnosis only, is
...
ENV_MODE = "SATQUERY_MODE"
ENV_DISABLE = "SATQUERY_AIRGAP_GUARD"
...
def guard_disabled_by_env() -> bool:
    """True only when SATQUERY_AIRGAP_GUARD is explicitly "0"."""
...
def enforce_from_env() -> None:
    ...
    Called from ``satquery/__init__`` so that a process started with
