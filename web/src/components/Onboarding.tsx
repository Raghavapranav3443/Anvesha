      ...
      <div className="fade-up w-full max-w-xl rounded-2xl border border-line bg-panel p-8 shadow-2xl">
        ...
        <div className="mt-6 flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <button onClick={onDone} className="rounded-lg px-4 py-2 text-base text-muted hover:text-body">Skip</button>
            <button
              onClick={() => (step < STEPS.length - 1 ? setStep(step + 1) : onDone())}
              className="rounded-lg bg-accent px-6 py-2 text-base font-semibold text-white hover:bg-accent-dim">
