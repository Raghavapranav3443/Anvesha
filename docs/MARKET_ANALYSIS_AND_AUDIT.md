# Anvesha AI (SIH26167) — Market Analysis & Full Codebase Audit Report
...
| V7 | No auth by default | ✅ **TRUE** | `ANVESHA_TOKEN` optional; `Depends(_check_auth)` no-ops without it. Port 8000 on venue LAN = open API. |
